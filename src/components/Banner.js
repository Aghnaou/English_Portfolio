                ...
                <div className="banner-content">
                  ...
                  <div className="description-container">
                    <p className="main-description">
                      Software Engineering graduate from <strong>INPT</strong>, skilled in <strong>Backend & Frontend</strong> development, database design and application integration. Experienced in <strong>Java/Spring Boot</strong>, <strong>Angular</strong>, <strong>Generative AI (RAG, MCP)</strong> and <strong>Microservices</strong> architectures.
                    </p>
                  </div>
                </div>
              </div>}
