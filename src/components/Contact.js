...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    emailjs.send(serviceID, templateID, formDetails, userID)
      .then(() => { setButtonText("Send"); setFormDetails(formInitialDetails); setStatus({ success: true, message: "Message sent successfully!" }); })
      .catch(() => { setButtonText("Send"); setStatus({ success: false, message: "Something went wrong, please try again." }); });
  };
